  ...
  <div class="container-fluid stHeader__container">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="studentNavbar">
      <nav class="navbar-nav stNav">
        <a class="nav-link stNav__link animation-pulse" href="<?= BASE_URL ?>student/dashboard">Dashboard</a>
        <a class="nav-link stNav__link animation-pulse" href="<?= BASE_URL ?>student/books">Books</a>
        <a class="nav-link stNav__link animation-pulse" href="<?= BASE_URL ?>student/borrowed">Borrowed</a>
        <a class="nav-link stNav__link animation-pulse" href="<?= BASE_URL ?>student/reservations">Reservations</a>
        <a class="nav-link stNav__link animation-pulse" href="<?= BASE_URL ?>student/profile">Profile</a>
        <a class="nav-link stNav__link stNav__link--logout animation-pulse"
          href="<?= BASE_URL ?>phpscripts/logout.php">Logout</a>
      </nav>
    </div>
  </div>
</header>